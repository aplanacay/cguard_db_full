...
<div class="modal-body-large form-horizontal" id='modal-search-form-body' style="padding:10px 10px 20px 10px;">
    ...
    <?php
    echo $this->render('@app/modules/corn/views/browse/search/_searchregistration', ['model' => $searchModel]);
    ?>
</div>
...
?>
<legend>Browse Registration Data</legend>
<?php
...
//                    ],
                'toolbar' => [
                    ['content' =>
                        ...
                        Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['browse/registration'], ['data-pjax' => 0, 'class' => 'btn btn-default', 'title' => 'Reset Grid'])
                    ],
