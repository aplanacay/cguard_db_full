...
class ViewController extends Controller {
    ...
    public function actionIndex($id = null) {
        ...
        $query = $searchModel->search(Yii::$app->request->get(), \app\modules\corn\models\Germplasm::find()->select(['germplasm.*'])->groupBy('phl_no,id,creator_id,creation_timestamp,modifier_id,modification_timestamp')->orderBy("(substring(phl_no, {$phl_no_str}))::int, substring(phl_no, {$phl_no_str2})"));
